"""Strip nonessential PNG metadata from every Phase 0.2 PNG, pixel-perfectly.
...
def main() -> None:
    ...
    manifest = {
        "schema": "quantum-hub.phase-0-3d-repair-v2.png-metadata-sanitization.v1",
    ...
    print(f"QH_V2_SANITIZED_PNGS={len(records)}")
    print(f"QH_V2_PIXELS_PRESERVED={manifest['all_pixels_preserved']}")
    print(f"QH_V2_SANITIZATION_MANIFEST={OUTPUT.resolve()}")
