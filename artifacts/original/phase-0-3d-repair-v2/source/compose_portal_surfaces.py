...
def main() -> None:
    ...
    for name, image in (("physical-layout", physical), ("dom-layout", dom), ("layout-overlay", overlay)):
    ...
    manifest = {
        "schema": "quantum-hub.phase-0-3d-repair-v2.portal-surface-render.v1",
    ...
    print(f"QH_V2_PORTAL_SURFACES={len(outputs)}")
    print(f"QH_V2_PORTAL_LAYOUT_SHA256={manifest['layout_sha256']}")
