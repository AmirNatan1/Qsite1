...
const maradinCandidate = {
  ...
  evidence: "The field evidence showed how brightness, image distortion and clarity varied across projector positions, road surfaces, lighting and weather conditions.",
